...
# Usage:
#   ./scripts/coverage.sh                        # all tests, threshold 90%
#   ./scripts/coverage.sh test/src/services/     # specific path, threshold 100%
#   ./scripts/coverage.sh "" 95                  # all tests, custom threshold
#   ./scripts/coverage.sh --verbose              # summary + full output
#
