...
# Usage:
#   ./scripts/flutter_analyze.sh                    # summary with info breakdown
#   ./scripts/flutter_analyze.sh --verbose          # summary + full analyzer output
#   ./scripts/flutter_analyze.sh lib/src/model/     # specific directory
#
