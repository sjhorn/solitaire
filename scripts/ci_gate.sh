...
#
# Usage:
#   ./scripts/ci_gate.sh                  # full gate, summary only
#   ./scripts/ci_gate.sh --fix            # auto-fix format + lint before checking
#   ./scripts/ci_gate.sh --verbose        # full gate, verbose output
#   ./scripts/ci_gate.sh test/src/model/  # gate scoped to one layer
#
