...
# Usage:
#   ./scripts/flutter_test.sh                        # summary only
#   ./scripts/flutter_test.sh --verbose              # summary + full output
#   ./scripts/flutter_test.sh test/src/model/        # specific path
#   ./scripts/flutter_test.sh --coverage             # with coverage
#   ./scripts/flutter_test.sh --update-goldens       # update goldens
#   ./scripts/flutter_test.sh --filter "DocumentSelection"
#
