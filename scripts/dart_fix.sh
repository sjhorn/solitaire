...
# Usage:
#   ./scripts/dart_fix.sh preview            # summary only (default)
#   ./scripts/dart_fix.sh apply              # apply fixes
#   ./scripts/dart_fix.sh preview --verbose  # summary + full output
#   ./scripts/dart_fix.sh preview lib/       # preview specific directory
#
