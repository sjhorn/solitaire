...
# Usage:
#   ./scripts/dart_format.sh check              # summary only (default)
#   ./scripts/dart_format.sh fix                # apply formatting
#   ./scripts/dart_format.sh check --verbose    # summary + full output
#   ./scripts/dart_format.sh check lib/         # check specific directory
#
