...
# Usage:
#   ./scripts/log_tail.sh summary          # print all summaries
#   ./scripts/log_tail.sh tail test        # tail last 40 lines of test log
#   ./scripts/log_tail.sh tail analyze     # tail last 40 lines of analyze log
#   ./scripts/log_tail.sh grep "FAILED"    # grep pattern across all logs
#   ./scripts/log_tail.sh grep "error" analyze  # grep specific log
#   ./scripts/log_tail.sh failures         # show only failing tests
